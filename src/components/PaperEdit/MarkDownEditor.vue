...
<template>
  <editor.mavonEditor v-model="markdownValue" @save="dialogVisible = true" class="mavon-editor">
  </editor.mavonEditor>
  <div class="actions-btn">
    <el-button type="success" round @click="dialogVisible = true">保存文件</el-button>
    <el-upload ref="upload" class="upload-demo" :limit="1" :before-upload="beforeAvatarUpload" :on-exceed="handleExceed">
      <template #trigger>
