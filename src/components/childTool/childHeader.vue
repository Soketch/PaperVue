<template>
    <div class="header" :class="[{ fixedToTop }, themeColor]" ref="header">
        <ul class="navbar">
            ...
            <router-link exact to="/PaperEdit" v-slot="{ href, navigate, isActive }">
                <li class="navbar-item" :class="{ active: isActive }">
                    <a :href="href" @click="navigate">编辑</a>
                </li>
            </router-link>
            <router-link to="/SubScribe" v-slot="{ href, navigate, isActive }">
                <li class="navbar-item" :class="{ active: isActive }">
                    <a :href="href" @click="navigate">订阅</a>
                </li>
            </router-link>
            <router-link to="/ChatGroup" v-slot="{ href, navigate, isActive }">
                <li class="navbar-item" :class="{ active: isActive }">
