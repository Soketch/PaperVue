  ...
  <div class="header" :class="[{ fixedToTop }, themeColor]" ref="header">
    <div class="logo">
      <a href="/">
        ...
        <!-- <div :is-transparent="themeColor === 'is-transparent'"></div> -->
      </a>
    </div>
    <ul class="navbar">
      ...
      <router-link exact to="/Search" v-slot="{ href, navigate, isActive }">
        <li class="navbar-item" :class="{ active: isActive }">
          <a :href="href" @click="navigate">服务</a>
        </li>
      </router-link>
      <router-link to="/WorkBench" v-slot="{ href, navigate, isActive }">
        <li class="navbar-item" :class="{ active: isActive }">
          <a :href="href" @click="navigate">工作台</a>
        </li>
      </router-link>
